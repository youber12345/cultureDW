...
public class Event {
	...
	public Event(int event_num, String event_name, Date event_sdate, Date event_edate, String event_description,
			String event_ph, String event_price, String event_homepage, String event_poster, String event_address,
			String event_tag, String event_guName, String event_lat, String event_lot) {
