...
<%@ page import="DTO.Event,DAO.EventDAO, mybatis.MyBatisConfig"%>
    ...
    <div class="container">
        <div class="content">
            <div class="description">
                ...
                <div class="icons">
                    <div><img src="<%= request.getContextPath() %>/static/icon/blackfav.png" width="50px" height="50px" onclick="toggleHeart(${event.event_num})"></div>
