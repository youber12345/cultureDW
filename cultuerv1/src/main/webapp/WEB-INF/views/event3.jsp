...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="icons">
                <div><img src="<%= request.getContextPath() %>/static/icon/favorite.png" width="30px" height="30px" onclick="toggleHeart(this)"> <!-- 클릭하면 조회수 올라가기  -->  </div>
                <div><img src="<%= request.getContextPath() %>/static/icon/share.png" width="30px" height="30px" onclick="share()">  <!-- 클릭하면 조회수 올라가기  -->  </div>
                <div><img src="<%= request.getContextPath() %>/static/icon/chat.png" width="30px" height="30px" onclick="chatting()">    </div>
            </div>
